        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakStartTime = table.Column<int>(type: "integer", nullable: false),
                    BreakEndTime = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RangeEnd = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignUpRequest = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BiochemistSignupRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BiochemistSignupRequests_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Biochemists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Biochemists_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorSignupRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorSignupRequests_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClinicRooms_Clinics_ClinicId",
                        column: x => x.ClinicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountId = table.Column<int>(type: "integer", nullable: false),
                    ClinicId = table.Column<int>(type: "integer", nullable: false),
                    ClinicRoomId = table.Column<int>(type: "integer", nullable: false),
                    FirstName = table.Column<string>(type: "text", nullable: false),
                    LastName = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Doctors_ClinicRooms_ClinicRoomId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Injections_Drugs_DrugId",
                        column: x => x.DrugId,
            ...
            migrationBuilder.CreateTable(
                name: "AppointmentTestResults",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AppointmentTestId = table.Column<int>(type: "integer", nullable: false),
                    ResultDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Value = table.Column<decimal>(type: "numeric", nullable: false),
                    BiochemistId = table.Column<int>(type: "integer", nullable: false),
                    ResultFlag = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentTestResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppointmentTestResults_AppointmentTests_AppointmentTestId",
                        column: x => x.AppointmentTestId,
                        principalTable: "AppointmentTests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentTestResults_Biochemists_BiochemistId",
                        column: x => x.BiochemistId,
                        principalTable: "Biochemists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentTestResults_AppointmentTestId",
                table: "AppointmentTestResults",
                column: "AppointmentTestId");

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentTestResults_BiochemistId",
                table: "AppointmentTestResults",
                column: "BiochemistId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentTests_TestId",
                table: "AppointmentTests",
                column: "TestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BiochemistSignupRequests_AccountId",
                table: "BiochemistSignupRequests",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Biochemists_AccountId",
                table: "Biochemists",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicRooms_ClinicId",
                table: "ClinicRooms",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorSignupRequests_AccountId",
